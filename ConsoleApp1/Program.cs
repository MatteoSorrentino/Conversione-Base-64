...
namespace ConsoleApp1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("");
            int parola = 0;
            Console.WriteLine("inserisci un numero da convertire in una carattere ascii");
            Console.WriteLine("");
            parola = Convert.ToInt32(Console.ReadLine());
            char c = Convert.ToChar(parola);
            Console.WriteLine($"il valore {parola} è trasformata in {c}");
